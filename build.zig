...
pub fn build(b: *Builder) !void {
    ...
    const enable_snapshots = b.option(bool, "snapshot", "Whether to enable linker state snapshotting") orelse false;
    ...
    exe_options.addOption(bool, "enable_snapshots", enable_snapshots);
    ...
    test_stage2_options.addOption(bool, "enable_snapshots", enable_snapshots);
